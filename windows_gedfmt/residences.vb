...
Public Class residences
    ...
    Public Function Add(ByVal ResidenceYear As String) As String
        Dim cNewRec As New outSection
        Dim strRTN As String = ResidenceYear
        If SectionExists(ResidenceYear) = False Then
            cNewRec.SectionYear = ResidenceYear
