    ...
    Public Sub ParseSources()
        ...
        For intloop = 0 To IncomingText.Length - 1
            If IncomingText(intloop).Contains("auto-generated by a GEDCOM") = True Then
                If RetainImportInfo() = True Then
                    sbld.Clear()
                    sbld.Append(IncomingText(intloop))
                    sbld.Replace("''", "")
                    sbld.Replace("This biography was auto-generated by a GEDCOM import.", "")
                    sbld.Replace("This comment and citation can be deleted after the biography has been edited and primary sources are included.", "")
                    sbld.Replace("It's a rough draft and needs to be edited.", "")
                    sbld.Replace("<ref>", "")
                    sbld.Replace("</ref>", "")
                    cOut.Acknowledgements.OtherLines.Add(sbld.ToString.Trim)
                    IncomingText(intloop) = ""
                Else
                    IncomingText(intloop) = ""
                End If
            ...
            ElseIf IncomingText(intloop).Contains("''No more info is currently available. Can you add") = True Then
                If RetainNoMoreInfo() = False Then
                    IncomingText(intloop) = ""
                End If
        ...
        If listYearOrder.Count > 0 Then
            listYearOrder.Sort()
        End If
        If listYearOrder.Count <= ADD_THRESHOLD Then
            If RetainNoMoreInfo() = True Then
                If bNoInfoFound = False Then
                    If AddNoMoreInfo() = True Then
                        listOutput.Add(":''No more info is currently available. Can you add to this biography?''")
                    End If
                End If
            End If
        End If
        ...
        If cOut.Acknowledgements.OtherLines.Count > 0 Then
            ...
            For Each strline In cOut.Acknowledgements.OtherLines
                ...
                listOutput.Add("")
            Next
            listOutput.Add("<!-- Please feel free to remove this item if you wish. I appreciate it may not be relevant or important to you. If you leave it then THANKS! -->")
        ...
        Else
            listOutput.Add("<!-- Please feel free to remove this section if you wish. I appreciate it may not be relevant or important to you. If you leave it then THANKS! -->")
            listOutput.Add("==Acknowledgements==")
            listOutput.Add(":Initial bio tidy after GEDCOM import created using [https://www.wikitree.com/wiki/Space:WikiTree_Text_Formatter WikiTree Text Formatter] by [[Meredith-1182|David Loring]]")
        End If
        '
